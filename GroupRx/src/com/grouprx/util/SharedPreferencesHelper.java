...
public class SharedPreferencesHelper
{
	...
	public static void init(Context context)
	{
		...
		settingsPreferences = context.getSharedPreferences("settingsGroupRx", Context.MODE_PRIVATE);
		dataPreferences = context.getSharedPreferences("dataGroupRx", Activity.MODE_PRIVATE);
	}
